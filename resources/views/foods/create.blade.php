                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('foods.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="preparation_time" class="block mt-1 w-full" type="number" name="preparation_time" :value="old('preparation_time')" required />
                            <x-input-error :messages="$errors->get('preparation_time')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <label for="is_available" class="inline-flex items-center">
                                <input id="is_available" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_available" value="1" {{ old('is_available') ? 'checked' : '' }}>
